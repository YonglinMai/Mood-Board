...
function alive(){
    ...
    aliveImg.forEach(function(aI){
        $(".pics").append("<img src=" + aI + ">");
    });
}
function depressed(){
    displayColor("blue");
    backgroundImg(background[2]);
    depressedImg.forEach(function(deI){
        $(".pics").html("<img src=" + deI + ">");
    });
}
function hopeless(){
    displayColor("red");
    backgroundImg(background[3]);
    hopelessImg.forEach(function(hI){
        $(".pics").html("<img src=" + hI + ">");
    });
}
