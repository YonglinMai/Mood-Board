...
var hopeless=["http://www.poluoluo.com/qq/UploadFiles_7828/201210/2012101414564129.jpg","https://chinadigitaltimes.net/chinese/files/2013/07/%E6%BC%AB%E7%94%BB%E6%B2%89%E7%9F%B3%EF%BC%9A%E7%BB%9D%E6%9C%9B.jpg", "http://p0.ifengimg.com/pmop/2018/0411/9E05E00034E561B6AF5B27A586574B4B82F52081_size76_w640_h701.jpeg"];
...
$(".go").click(function(){
    clearInput();
    var Feel=$(".feeling").val();
    if(Feel ==="delighted"){
        delighted();
    }
    else if(Feel === "alive"){
    }
    else if (Feel === "depressed"){
    }
    else if (Feel === "hopeless"){
    }
    else{
    }
});
